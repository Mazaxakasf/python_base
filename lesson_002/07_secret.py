...
#
message_total= secret_message[0][3] + secret_message[1][9:13] + secret_message[2][5:15:2]
sl_1= secret_message[0][3].upper()
sl_2= secret_message[1][9:13]
sl_3= secret_message[2][5:15:2]
sl_4= secret_message[3][7:13][::-1]
sl_5= secret_message[4][16:21][::-1]

print("%s %s %s %s %s!"%(sl_1, sl_2, sl_3, sl_4,sl_5))
