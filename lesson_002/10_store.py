...
table_price_1 = table_item_1['quantity'] * table_item_1['price']
table_price_2 = table_item_2['quantity'] * table_item_2['price']
table_cost = table_price_1 + table_price_2
...
sofa_price_1 = sofa_item_1['quantity'] * sofa_item_1['price']
sofa_price_2 = sofa_item_2['quantity'] * sofa_item_2['price']
sofa_cost = sofa_price_1 + sofa_price_2
...
chair_price_1 = chair_item_1['quantity'] * chair_item_1['price']
chair_price_2 = chair_item_2['quantity'] * chair_item_2['price']
chair_price_3 = chair_item_3['quantity'] * chair_item_3['price']
chair_cost = chair_price_1 + chair_price_2 + chair_price_3
